...
const navigation = [
    ...
    { name: 'Artículos', to: '/articulos', current: false },
    { name: 'authLayout', to: '/signin', current: false },
]
...
export default function Navbar() {
    return (
        <>
            ...
            <Disclosure as="nav" className="bg-gray-800 fixed top-0 left-0 right-0" id='mi_navbar'>
                {({ open }) => (
                    <>
                                ...
                                <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                                    <Link
                                        ...
                                        <img
                                            ...
                                            alt="Logo La Casa Del Carpintero"
                                        />
                                    </Link>
